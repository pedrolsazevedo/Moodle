...
function install_java_and_jmeter
{
    ...
    wget -O tmp-for-plugin-install.jmx https://raw.githubusercontent.com/psilvaazevedo/Moodle/main/loadtest/simple-test-1.jmx || return 1
...
LOADTEST_BASE_URI=https://raw.githubusercontent.com/psilvaazevedo/Moodle/main/loadtest
...
function run_load_test_example
{
    ...
    deploy_run_test1_teardown ltest6 southcentralus https://raw.githubusercontent.com/psilvaazevedo/Moodle/main/azuredeploy.json azuredeploy.parameters.loadtest.defaults.json apache Standard_DS2_v2 mysql 4 125 nfs 2 128 false "$(cat ~/.ssh/authorized_keys)" 1600 4800 18000
}
...
function run_load_test_postgres
{
    ...
    deploy_run_test1_teardown pgres southcentralus https://raw.githubusercontent.com/psilvaazevedo/Moodle/main/azuredeploy.json azuredeploy.parameters.loadtest.defaults.json apache Standard_DS2_v2 postgres 16 256 nfs 2 128 false "$(cat ~/.ssh/authorized_keys)" 800 2400 36000
}
